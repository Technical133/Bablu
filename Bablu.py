#!/usr/bin/python2
#coding=utf-8
#Codded By Technical Naqeeb
#Editing My Script Will Not Make You A Coder
#Facebook      :Technical.naqeeb.133
...
\x1b[1;88m╚═════╝░╚═╝░░╚═╝╚═════╝░╚══════╝░╚═════╝░
\x1b[1;97m==============================
\x1b[1;86m➣  YouTube     : Technical Naqeeb
\x1b[1;95m➣  Facebook    : Technical.naqeeb.133
\x1b[1;93m➣  Whatsapp    : +923488136133
...
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
		print("\r\x1b[1;95mPlease Wait \x1b[1;93m"+o),;sys.stdout.flush();time.sleep(1)
...
CorrectUsername = "Bablu"
CorrectPassword = "Bablu"
...
def login():
	...
	try:
		...
		jalan(' \033[1;97m   ✧ \033[1;95mWarning: \033[1;95mUse a New Account To Login' )
		jalan(' \033[1;97m   ✧ \033[1;95m👉 : \033[1;95mBablu' ) 
		
		print('	' )
		print('      \033[1;97m      ✧ \x1b[1;95mLogin With Facebook\x1b[1;97m ✧')
		print('	' )
...
def menu():
	...
	print "\033[1;97m✧\033[1;97m.\033[1;97m1.\x1b[1;97m Start Cloning   Please Wait..."
      
      
        print "\033[1;97m✧\033[1;97m.\033[1;97m2.\033[1;97m Follow Me On YouTube  And Facebook For Help"
...
def super():
	...
	os.system('clear')
	print logo
	print "\033[1;97m✧ \033[1;97m1.\x1b[1;95mClone From Friend List."
	print "\033[1;97m✧ \033[1;97m2.\x1b[1;95mClone From Public ID."
	print "\033[1;97m✧ \033[1;97m0.\033[1;95mBack."
	pilih_super()
...
def pilih_super():
	...
	titik = ['.   ','..  ','... ']
	for o in titik:
		print("\r\033[1;97m[✔] Cloning Started Now\033[1;97m"+o),;sys.stdout.flush();time.sleep(1)
        print"""
...
---------------------------------------------------------"""		
	...
	print '\033[1;95mCloning Has Been Completed.'
	print"\033[1;95m-----------------"
